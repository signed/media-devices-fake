...
describe('MediaStreamFake', () => {
  test('create a new one', () => {
    expect(new MediaStreamFake(anyContext(), mediaStreamId(), [])).toBeDefined()
  })

  test('do not leak internal state ', () => {
    const fake = new MediaStreamFake(anyContext(), mediaStreamId(), [])
  ...
  test('derive active state from contained tracks', () => {
    ...
    const fake = new MediaStreamFake(anyContext(), mediaStreamId(), [liveTrack])
  ...
  test('filtered tracks', () => {
    ...
    const fake = new MediaStreamFake(anyContext(), mediaStreamId(), [audioTrack, videoTrack])
  ...
  test('return track by id', () => {
    ...
    const fake = new MediaStreamFake(anyContext(), mediaStreamId(), [wantedTrack])
  ...
  test('remove track', () => {
    ...
    const fake = new MediaStreamFake(anyContext(), mediaStreamId(), [one, two, three])
